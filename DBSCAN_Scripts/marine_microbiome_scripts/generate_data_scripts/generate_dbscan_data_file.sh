...
TEMP_DATA_PATH="/projects/bgmp/shared/groups/2020/prophage/dbscan_data/dbscan_data_marine_genomes/temp_data.tsv"
PROPHAGE_DATA_PATH="/projects/bgmp/shared/groups/2020/prophage/dbscan_data/dbscan_data_marine_genomes/dbscan_marine_data.tsv"
DIRECTORY_NAMES_PATH="/projects/bgmp/shared/groups/2020/prophage/dbscan_data/dbscan_data_marine_genomes/dbscan_marine_directory_names.txt"
